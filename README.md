...
- [Setup Instructions](./_docs/setup.md) - Setup instructions is a clear documentation of the setup of the primary Fedora VM. Includes details of VM configuration, tool installation, shell configuration, and more 
- [Github Recovery Tool](./_docs/git-heal.md) - tool created to remedy local git repo corruption. 
- [Notes](./_docs/notes.md) - Notes is a record of steps and personal observations taken during this lab. Includes valuable information, such as specific commands to dconfigure and debug failueres, as well as notes on said failures and steps taken to resolve such errors. 
